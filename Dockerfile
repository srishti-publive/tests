...
# Install system dependencies: libpq-dev/gcc for psycopg2.
...
# Collect static files at build time. Prod settings no longer require any external
# service to import (state is database-backed), so this runs without extra env.
