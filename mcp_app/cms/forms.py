...
SCHEMAS = [
    {
        ...
        "description": (
            ...
            "get_form_schema to discover required field names and types. "
        ...
        "inputSchema": {
            ...
            "properties": {
                "form_schema_id":   {"type": "string", "description": "Form schema ID (24-character hex, same as schema_id in get_form_schema)"},
